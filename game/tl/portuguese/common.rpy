# TODO: Translation updated at 2021-04-26 22:27
...
translate portuguese strings:
    ...
    new "Abertura da área de transferência ativada."
    ...
    new "Tem certeza de que deseja substituir o salvamento?"

    # renpy/common/00gui.rpy:377
    old "Loading will lose unsaved progress.\nAre you sure you want to do this?"
    new "Carregar fará perder o progresso não salvo.\nTem certeza de que deseja fazer isso?"
    ...
    new "Este programa contém software livre sob várias licenças, incluindo a Licença MIT e a Licença Pública Geral Menor GNU. Uma lista completa de software, incluindo links para o código-fonte completo, pode ser encontrada em {a=https://www.renpy.org/l/license}here{/a}."
    ...
    old "self voicing volume drop"
    new "queda do volume da auto voz"
    ...
    new "A auto-voz diria \"[renpy.display.tts.last]\". Pressione 'alt + shift + V' para desabilitar."

    # renpy/common/00preferences.rpy:575
    old "Self-voicing enabled. Press 'v' to disable."
    new "Auto-voz ativada. Pressione 'v' para desativar."
    ...
    new "Ocultar Log de Carregamento de Imagem (F4)"
    ...
    new "Entrando em contato com a App Store\nPor favor, aguarde..."
    ...
    new "Esta conta não tem permissão para escrever no log de atualização."
    ...
    new "Durante a descompactação {}, unknown type {}."
    ...
    new "[u.version] está disponível. Você quer instalá-lo?"
    ...
    new "Este computador tem problemas para exibir gráficos: [problem]."

    # renpy/common/00gltest.rpy:255
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display."
    new "Seus drivers gráficos podem estar desatualizados ou podem não estar funcionando corretamente. Isso pode levar a uma exibição gráfica lenta ou incorreta."
    ...
    new "Continuar, Mostre este aviso novamente"

    # renpy/common/00gltest.rpy:273
    old "Continue, Don't show warning again"
    new "Continuar, Não mostre aviso novamente"
    ...
    new "Abre um console para permitir o debugging do problema."
